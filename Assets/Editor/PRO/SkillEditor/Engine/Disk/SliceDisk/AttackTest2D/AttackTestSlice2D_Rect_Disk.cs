...
namespace PRO.SkillEditor
{
    public class AttackTestSlice2D_Rect_Disk : AttackTestSlice2DBase_Disk
    {
        ...
        {
            RaycastHit2D[] hits = Physics2D.BoxCastAll(agent.transform.position + agent.transform.rotation * position, scale, rotation.eulerAngles.z, Vector2.zero, 0, 1 << (int)GameLayer.Role);
