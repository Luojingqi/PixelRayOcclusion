...
namespace PRO.SkillEditor
{
    internal class SceneRuinSlice : SliceBase
    {
        ...
        public override void Select()
        {
            ...
            diskData.EditorShow(SkillVisualEditorWindow.Inst.Config.Agent, Track.trackIndex);
            SkillVisualEditorWindow.Inst.Config.Agent.transform.Find($"场景破坏轨道{Track.trackIndex}").gameObject.SetActive(true);
        }
        public override void UnSelect()
        {
            base.UnSelect();
            if (SkillVisualEditorWindow.Inst.Config.Agent == null) return;
            SkillVisualEditorWindow.Inst.Config.Agent.transform.Find($"场景破坏轨道{Track.trackIndex}").gameObject.SetActive(false);
        }
        ...
        private void 剔除重复点Action()
        {
            ...
            int index = 0;
            foreach (var selectSlice in SkillVisualEditorWindow.Inst.SelectSliceHash)
            {
