...
namespace PRO.SkillEditor
{
    public class Console
    {
        ...
        public Console(VisualElement view)
        {
           ...
           // SkillVisualEditorWindow.Inst.TimeScaleAxis.MaxFrame = Math.Abs(MaxFrameField.value);
            MaxFrameField.RegisterCallback<BlurEvent>(evt =>
            {
                int value = Math.Abs(MaxFrameField.value);
                SkillVisualEditorWindow.Inst.TimeScaleAxis.MaxFrame = value;
            ...
            NowFrameField.RegisterCallback<BlurEvent>(evt =>
            {
                ...
                SkillVisualEditorWindow.Inst.TimeScaleAxis.NowFrame = value;
                SkillVisualEditorWindow.Inst.TimeScaleAxis.Align();
            });

            LeftFrameButton.clicked += () =>
            {
                SkillVisualEditorWindow.Inst.TimeScaleAxis.NowFrame--;                
                SkillVisualEditorWindow.Inst.TimeScaleAxis.Align();
            };
            ...
            {
                SkillVisualEditorWindow.Inst.IsUpdate = !SkillVisualEditorWindow.Inst.IsUpdate;
            };
        }
        /// <summary>
        /// 设置当前帧文本
