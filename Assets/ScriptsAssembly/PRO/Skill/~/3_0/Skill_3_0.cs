...
namespace GamePlay
{
    public class Skill_3_0 : OperateFSMBase, IOperate_范围选择
    {
        public SkillPointer_范围内选择类 SkillPointer { get  ; set  ; }

        protected override void InitState()
        {
            AddState(new Skill_3_0_T0());
            AddState(new Skill_3_0_T1());
            AddState(new Skill_3_0_T2());
        }

        public class Skill_3_0_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_3_0)value; }
            private Skill_3_0 operate;
        ...
        public class Skill_3_0_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_3_0)value; }
            private Skill_3_0 operate;
        ...
        public class Skill_3_0_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_3_0)value; }
            private Skill_3_0 operate;
            private float time;
