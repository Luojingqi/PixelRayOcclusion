...
namespace GamePlay
{
    public class Skill_5_6 : OperateFSMBase, IOperate_射线选择
    {
        ...
        {
            AddState(new Skill_5_6_T0());
            AddState(new Skill_5_6_T1());
            AddState(new Skill_5_6_T2());
        }

        public class Skill_5_6_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_6)value; }
            private Skill_5_6 operate;
        ...
        public class Skill_5_6_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_6)value; }
            private Skill_5_6 operate;
        ...
        public class Skill_5_6_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_6)value; }
            private Skill_5_6 operate;
            private float time;
            public override void Enter()
            {
                ...
                particle.Renderer.color = BlockMaterial.GetPixelColorInfo("油色0").color;
                ...
                {
                    var pool = ParticleManager.Inst.GetPool("特殊粒子/油");
                    ...
                    foreach (var globalPos in list)
                    {
                        ...
                        particle.Rig2D.AddForce(Quaternion.Euler(0, Random.Range(-100, 100), 0) * d * Random.Range(5, 15));
