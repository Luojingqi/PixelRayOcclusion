...
namespace GamePlay
{
    public class Skill_6_3 : OperateFSMBase,IOperate_范围选择
    {
        ...
        {
            AddState(new Skill_6_3_T0());
            AddState(new Skill_6_3_T1());
            AddState(new Skill_6_3_T2());
        }

        public class Skill_6_3_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_6_3)value; }
            private Skill_6_3 operate;
        ...
        public class Skill_6_3_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_6_3)value; }
            private Skill_6_3 operate;
        ...
        public class Skill_6_3_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_6_3)value; }
            private Skill_6_3 operate;
