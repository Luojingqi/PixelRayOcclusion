...
namespace GamePlay
{
    public class Skill_5_1 : OperateFSMBase, IOperate_射线选择
    {
        ...
        {
            AddState(new Skill_5_1_T0());
            AddState(new Skill_5_1_T1());
            AddState(new Skill_5_1_T2());
        }

        public class Skill_5_1_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_1)value; }
            private Skill_5_1 operate;
        ...
        public class Skill_5_1_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_1)value; }
            private Skill_5_1 operate;
        ...
        public class Skill_5_1_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_1)value; }
            private Skill_5_1 operate;
            private float time;
            public override void Enter()
            {
                ...
                particle.Renderer.color = BlockMaterial.GetPixelColorInfo("水色0").color;
