...
namespace GamePlay
{
    public class Skill_8_0 : OperateFSMBase, IOperate_·¶Î§Ñ¡Ôñ
    {
        ...
        {
            AddState(new Skill_8_0_T0());
            AddState(new Skill_8_0_T1());
            AddState(new Skill_8_0_T2());
        }

        public class Skill_8_0_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_8_0)value; }
            private Skill_8_0 operate;
        ...
        public class Skill_8_0_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_8_0)value; }
            private Skill_8_0 operate;
            ...
            private bool Chack(PixelPosRotate posRotate)
            {
                ...
                for (int x = -2; x <= 1; x++)
                {
                    Pixel pixel = operate.Turn.Agent.Scene.GetPixel(BlockBase.BlockType.Block, start + posRotate.RotatePos(new Vector2Int(x, 0) + offset));
        ...
        public class Skill_8_0_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_8_0)value; }
            private Skill_8_0 operate;
