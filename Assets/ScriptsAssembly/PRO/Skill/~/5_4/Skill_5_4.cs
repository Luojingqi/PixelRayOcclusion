...
namespace GamePlay
{
    public class Skill_5_4 : OperateFSMBase, IOperate_射线选择
    {
        ...
        {
            AddState(new Skill_5_4_T0());
            AddState(new Skill_5_4_T1());
            AddState(new Skill_5_4_T2());
        }

        public class Skill_5_4_T0 : OperateStateBase_T0
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_4)value; }
            private Skill_5_4 operate;
        ...
        public class Skill_5_4_T1 : OperateStateBase_T1
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_4)value; }
            private Skill_5_4 operate;
        ...
        public class Skill_5_4_T2 : OperateStateBase_T2
        {
            public override OperateFSMBase Operate { get => operate; set => operate = (Skill_5_4)value; }
            private Skill_5_4 operate;
            private float time;
            public override void Enter()
            {
                ...
                particle.Renderer.color = Color.red;
                ...
                particle.RemainTimeIsZeroEvent += (p) =>
                {
                    ...
                    DrawTool.GetCircle(Block.WorldToGlobal(p.transform.position), 3, ref list);
                    foreach (var pos_G in list)
                        BuffEx.火焰(p.Scene, pos_G);
                    SetPool.PutIn(list);
                };
            }
