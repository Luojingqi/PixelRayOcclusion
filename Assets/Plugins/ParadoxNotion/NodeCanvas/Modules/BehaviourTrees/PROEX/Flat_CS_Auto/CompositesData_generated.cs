...
namespace PRO.BT.Flat.Composite
{
...
public struct ParallelData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.Composite.ParallelData> CreateParallelData(FlatBufferBuilder builder,
  ...
  public static Offset<PRO.BT.Flat.Composite.ParallelData> EndParallelData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Composite.ParallelData>(o);
  }
}
...
public struct SelectorData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.Composite.SelectorData> CreateSelectorData(FlatBufferBuilder builder,
  ...
  public static Offset<PRO.BT.Flat.Composite.SelectorData> EndSelectorData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Composite.SelectorData>(o);
  }
}
...
public struct SequencerData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.Composite.SequencerData> CreateSequencerData(FlatBufferBuilder builder,
      int last_running_node_index = 0) {
    builder.StartTable(1);
  ...
  public static void AddLastRunningNodeIndex(FlatBufferBuilder builder, int lastRunningNodeIndex) { builder.AddInt(0, lastRunningNodeIndex, 0); }
  public static Offset<PRO.BT.Flat.Composite.SequencerData> EndSequencerData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Composite.SequencerData>(o);
  }
}
