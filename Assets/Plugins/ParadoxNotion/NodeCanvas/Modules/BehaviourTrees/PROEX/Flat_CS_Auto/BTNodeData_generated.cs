...
public struct BTNodeData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.Base.BTNodeData> CreateBTNodeData(FlatBufferBuilder builder,
      byte status = 0,
  ...
  public static Offset<PRO.BT.Flat.Base.BTNodeData> EndBTNodeData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Base.BTNodeData>(o);
  }
}
...
public struct BehaviourTreeData : IFlatbufferObject
{
  ...
  public PRO.BT.Flat.Base.BTNodeData? AllNode(int j) { int o = __p.__offset(12); return o != 0 ? (PRO.BT.Flat.Base.BTNodeData?)(new PRO.BT.Flat.Base.BTNodeData()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  public int AllNodeLength { get { int o = __p.__offset(12); return o != 0 ? __p.__vector_len(o) : 0; } }

  public static Offset<PRO.BT.Flat.Base.BehaviourTreeData> CreateBehaviourTreeData(FlatBufferBuilder builder,
  ...
  public static VectorOffset CreateAllNodeVector(FlatBufferBuilder builder, Offset<PRO.BT.Flat.Base.BTNodeData>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
  public static VectorOffset CreateAllNodeVectorBlock(FlatBufferBuilder builder, Offset<PRO.BT.Flat.Base.BTNodeData>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAllNodeVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<PRO.BT.Flat.Base.BTNodeData>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
  public static VectorOffset CreateAllNodeVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<PRO.BT.Flat.Base.BTNodeData>>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartAllNodeVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
  public static Offset<PRO.BT.Flat.Base.BehaviourTreeData> EndBehaviourTreeData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Base.BehaviourTreeData>(o);
  }
}
...
static public class BehaviourTreeDataVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyVectorOfTables(tablePos, 12 /*AllNode*/, PRO.BT.Flat.Base.BTNodeDataVerify.Verify, false)
      && verifier.VerifyTableEnd(tablePos);
  }
}
