...
namespace PRO.BT.Flat.Decorator
{
...
public struct TimeoutData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.Decorator.TimeoutData> CreateTimeoutData(FlatBufferBuilder builder,
      float time_out = 0.0f) {
  ...
  public static Offset<PRO.BT.Flat.Decorator.TimeoutData> EndTimeoutData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.Decorator.TimeoutData>(o);
  }
}
