...
public struct ActionTaskData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.ActionTaskData> CreateActionTaskData(FlatBufferBuilder builder,
      byte status = 0,
  ...
  public static Offset<PRO.BT.Flat.ActionTaskData> EndActionTaskData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.ActionTaskData>(o);
  }
}
...
public struct ConditionTaskData : IFlatbufferObject
{
  ...
  public static Offset<PRO.BT.Flat.ConditionTaskData> CreateConditionTaskData(FlatBufferBuilder builder,
      int yield_return = 0,
      int yields = 0,
  ...
  public static VectorOffset CreateExtendVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<byte>(dataPtr, sizeInBytes); return builder.EndVector(); }
  public static void StartExtendVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(1, numElems, 1); }
  public static Offset<PRO.BT.Flat.ConditionTaskData> EndConditionTaskData(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<PRO.BT.Flat.ConditionTaskData>(o);
  }
}
