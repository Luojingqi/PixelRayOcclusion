...
public class Block : BlockBase
{
    ...
    /// 每区块所占像素点
    /// </summary>
    public static readonly Vector2Byte Size = new Vector2Byte(110, 110);
    #region 坐标转换
    /// <summary>
    /// 世界坐标点to块坐标
    /// </summary>
  ...
  //  public Queue<Vector2Byte> LiquidPressureUpdateQueue = new Queue<Vector2Byte>();
    ...
    public void Swap(Pixel p0, Pixel p1)
    {
        ...
        SetPixel(p0);
        SetPixel(p1);
        DrawPixelAsync(p0.pos, BlockManager.mat.GetPixelColorInfo(p0.id).color);
        DrawPixelAsync(p1.pos, BlockManager.mat.GetPixelColorInfo(p1.id).color);
    }
    ...
    public static void Swap(Vector2Int p0_G, Vector2Int p1_G)
    {
        ...
        block1.SetPixel(p0);
        block0.SetPixel(p1);
        block1.DrawPixelAsync(p0.pos, BlockManager.mat.GetPixelColorInfo(p0.id).color);
        block0.DrawPixelAsync(p1.pos, BlockManager.mat.GetPixelColorInfo(p1.id).color);
    }
}
