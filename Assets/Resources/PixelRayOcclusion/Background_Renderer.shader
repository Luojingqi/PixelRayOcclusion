    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return float4(lightColor.xyz *  pixelColor.xyz + pixelColor.xyz * (colorInfo.selfLuminous + 0.0125)  , 1.0);//max( colorInfo.color.w / 255.0 * pixelInfo.affectsTransparency , 0.75));
            }
